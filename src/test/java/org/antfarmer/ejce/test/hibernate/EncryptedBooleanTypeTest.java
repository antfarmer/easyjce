...
import org.antfarmer.ejce.hibernate.EncryptedBooleanType;
 ...
 * @version 1.0
 */
public class EncryptedBooleanTypeTest extends AbstractEncryptedTypeTest<Boolean> {
	...
	protected AbstractHibernateType createHibernateType() {
		return new EncryptedBooleanType();
	}
