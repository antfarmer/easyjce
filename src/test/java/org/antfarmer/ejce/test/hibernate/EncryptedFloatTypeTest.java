...
import org.antfarmer.ejce.hibernate.EncryptedFloatType;
 ...
 * @version 1.0
 */
public class EncryptedFloatTypeTest extends EncryptedFloatType {
	...
	public void test() throws GeneralSecurityException {
		final Float o = 22.99999999F;
		final String enc = encrypt(o);
		final Object dec = decrypt(enc);
		assertEquals(o, dec);

		assertSame(Float.class, returnedClass());
	}
