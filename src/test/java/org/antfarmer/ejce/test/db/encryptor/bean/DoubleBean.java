 ...
 */
@Entity
public class DoubleBean extends AbstractEncryptedValueBean<Double> {
	 ...
	 */
	@Override
	@Type(type = "org.antfarmer.ejce.hibernate.EncryptedDoubleType", parameters = {
			...
			@Parameter(name = "key", value = "QJ2MStUt9QSKZTpu07XuVTvihsvvI8tXwBLs73+E6PM"),
