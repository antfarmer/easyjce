...
/**
 * Hibernate UserType class which encrypts and decrypts double values transparently. This ensures
 ...
 * @version 1.0
 */
public class EncryptedDoubleType extends AbstractHibernateType {
	...
	protected Object decrypt(final String value) throws GeneralSecurityException {
		return getEncryptor().decryptDouble(value);
	}
	...
	protected String encrypt(final Object value) throws GeneralSecurityException {
		return getEncryptor().encryptDouble((Double) value);
	}
