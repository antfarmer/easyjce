...
/**
 * Hibernate UserType class which encrypts and decrypts integer values transparently. This ensures
 ...
 * @version 1.0
 */
public class EncryptedIntegerType extends AbstractHibernateType {
	...
	protected Object decrypt(final String value) throws GeneralSecurityException {
		return getEncryptor().decryptInteger(value);
	}
	...
	protected String encrypt(final Object value) throws GeneralSecurityException {
		return getEncryptor().encryptInteger((Integer) value);
	}
