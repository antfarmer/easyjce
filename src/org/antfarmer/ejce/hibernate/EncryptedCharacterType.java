...
/**
 * Hibernate UserType class which encrypts and decrypts character values transparently. This ensures
 ...
 * @version 1.0
 */
public class EncryptedCharacterType extends AbstractHibernateType {
	...
	protected Object decrypt(final String value) throws GeneralSecurityException {
		return getEncryptor().decryptCharacter(value);
	}
	...
	protected String encrypt(final Object value) throws GeneralSecurityException {
		return getEncryptor().encryptCharacter((Character) value);
	}
