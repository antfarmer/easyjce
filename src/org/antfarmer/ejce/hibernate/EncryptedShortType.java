...
/**
 * Hibernate UserType class which encrypts and decrypts short values transparently. This ensures
 ...
 * @version 1.0
 */
public class EncryptedShortType extends AbstractHibernateType {
	...
	protected Object decrypt(final String value) throws GeneralSecurityException {
		return getEncryptor().decryptShort(value);
	}
	...
	protected String encrypt(final Object value) throws GeneralSecurityException {
		return getEncryptor().encryptShort((Short) value);
	}
