...
/**
 * Hibernate UserType class which encrypts and decrypts boolean values transparently. This ensures
 ...
 * @version 1.0
 */
public class EncryptedBooleanType extends AbstractHibernateType {
	...
	protected Object decrypt(final String value) throws GeneralSecurityException {
		return getEncryptor().decryptBoolean(value);
	}
	...
	protected String encrypt(final Object value) throws GeneralSecurityException {
		return getEncryptor().encryptBoolean((Boolean) value);
	}
