...
/**
 * Hibernate UserType class which encrypts and decrypts float values transparently. This ensures
 ...
 * @version 1.0
 */
public class EncryptedFloatType extends AbstractHibernateType {
	...
	protected Object decrypt(final String value) throws GeneralSecurityException {
		return getEncryptor().decryptFloat(value);
	}
	...
	protected String encrypt(final Object value) throws GeneralSecurityException {
		return getEncryptor().encryptFloat((Float) value);
	}
